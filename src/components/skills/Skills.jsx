...
const Skills = () => {
  ...
  return (
    <div id='skills' className='container pt-20 max-w-full my-40 flex flex-col'>
      <h1 className='text-2xl font-bold text-center md:text-3xl lg:text-4xl'  data-aos="fade-up" data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='2000'>My Programming Skills</h1>
      <ul className='w-11/12 mx-auto text-center my-10 flex justify-evenly items-center' data-aos="fade-up" data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='2000'>
