...
const Hero = () => {
  return (
    <section id='home' className='container mx-auto py-20 sm:py-28 md:py-36 lg:py-40 lg:flex lg:flex-row-reverse lg:justify-between lg:items-center 2xl:py-48'>
        ...
        <img src={Programmer} alt="Programmer" loading='lazy' width='240' className='mx-auto lg:w-1/3 lg:mr-28 lg:place-content-end'  data-aos="fade-up" data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='1000'/>
