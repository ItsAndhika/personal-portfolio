...
const Hero = () => {
  return (
    <div id='home' className='container max-w-full h-screen pt-14 lg:flex lg:flex-row-reverse lg:justify-between lg:items-center'>
        ...
        <img src={Programmer} alt="Programmer" loading='lazy' className='w-60 mx-auto lg:w-1/3 lg:mr-28 lg:place-content-end'  data-aos="fade-down" data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='2000'/>
		<div id='content' className='text-center lg:mx-auto' data-aos="fade-down" data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='2000'>
			<Facebook />
			<Discord />
			<Github />
			<Bio />
