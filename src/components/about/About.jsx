...
const About = () => {
  return (
    <div id='about' className='container pt-24 max-w-full flex flex-col justify-center items-center sm:pt-0'  data-aos="fade-down" data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='2000'>
