...
const About = () => {
  return (
    <div id='about' className='container pt-24 max-w-full flex flex-col justify-center items-center 2xl:pt-44' data-aos="fade-up" data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='2000'>
      <h1 className='text-3xl font-bold sm:text-4xl 2xl:text-7xl'>About Me</h1>
