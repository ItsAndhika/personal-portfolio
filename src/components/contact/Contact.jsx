...
const Contact = () => {
  return (
    <div id='contact' className='container max-w-full pt-20 mx-auto flex flex-col justify-center items-center'>
      <h1 className='text-2xl font-bold mb-5 md:text-3xl lg:text-4xl' data-aos="fade-down" data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='2000'>Contact Me</h1>
