...
const Hero = () => {
  return (
    <div className='h-[3000px] pt-14'>
        <img src={Programmer} alt="Programmer" loading='lazy' className='w-72 mx-auto'/>
        <div id='social-medias' className='mx-auto text-center mb-2'>
            <a href="https://m.facebook.com/profile.php?id=100056986006962">
                <svg
					fill="#000000"
                    className="mx-2 inline w-8 mt-3 fill-black dark:fill-white"
					viewBox="-5.5 0 32 32"
					version="1.1"
            ...
            <a href="https://discord.com/users/832254421835448370">
                <svg
                	xmlns="http://www.w3.org/2000/svg"
                	className="mx-2 inline w-6 mt-3 fill-black dark:fill-white"
                	fill="none"
                	viewBox="0 0 640 512"
                >
                	<path
        ...
        <div className='text-center'>
            ...
            <div className='text-2xl flex justify-center items-center my-2'>
            ...
            <p
				className="text-white mx-auto w-1/2 mb-3 font-semibold text-center font-montserrat text-lg"
			>
				A Junior
				<span
